...
export default function Lobby() {
    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            <div style={{ background: '#0d0d1a', minHeight: '100vh', width: '100%', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem 1rem', fontFamily: "'Share Tech Mono', monospace", userSelect: 'none' }}>
            ...
            <div style={{ position: 'fixed', top: '2.5rem', left: '2rem', zIndex: 1000 }}>
                <PtsBadge pts={796} />
            </div>
